...
// Receive and decode JSON object
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	// If the request body besides a single JSON object contains anything else,
	// i.e., additional data in the request body, we return the custom error.
...
// readCSV helper returns a string value from the query string, and then splits
// it into a slice on the comma character. If no matching could be found, it
...
// an integer before returning. If no matching key could be found it returns the
